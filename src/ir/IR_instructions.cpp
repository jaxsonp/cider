...
namespace ir::instr
{
	...
	AddInstruction::AddInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::Add), dest(dest), op1(op1), op2(op2) {}

	SubtractInstruction::SubtractInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::Sub), dest(dest), op1(op1), op2(op2) {}

	MultiplyInstruction::MultiplyInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::Mul), dest(dest), op1(op1), op2(op2) {}

	DivideInstruction::DivideInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::Mul), dest(dest), op1(op1), op2(op2) {}

	ModuloInstruction::ModuloInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::Mul), dest(dest), op1(op1), op2(op2) {}

	BitwiseOrInstruction::BitwiseOrInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::BitOr), dest(dest), op1(op1), op2(op2) {}

	BitwiseXorInstruction::BitwiseXorInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::BitXor), dest(dest), op1(op1), op2(op2) {}

	BitwiseAndInstruction::BitwiseAndInstruction(VRegId dest, VRegId op1, IrValue op2)
		: Instruction(Op::BitAnd), dest(dest), op1(op1), op2(op2) {}

	ReturnInstruction::ReturnInstruction()
		: TerminalInstruction(Op::Return) {}

	ReturnInstruction::ReturnInstruction(IrValue _ret_value)
